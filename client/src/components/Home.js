  ...
  return (
    <div className="w-[100%] h-screen flex flex-col items-center justify-evenly -mt-10">
      <div className="text-center">
        <h1 className="text-4xl font-bold tracking-widest mt-12">LATEST HOMES</h1>
      ...
      <div className="flex gap-8 w-full items-center">
        ...
        <div ref={scrollContainerRef} className="flex gap-4 bg-white overflow-x-auto scrollbar-thin scrollbar-thumb-primary scrollbar-track-primary">
        {homes.map((home) => (
          <div key={home.id} className="min-w-80 h-[500px] flex items-center flex-shrink-0 mx-2">
            <Card css={{ w: "100%", h: "300px" }} className="transform hover:scale-110 transition-all duration-300">
